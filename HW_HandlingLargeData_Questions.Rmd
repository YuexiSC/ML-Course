...
library(plyr)
unique(dataset$sex)
###Old: Fall Apart in both Male and Female
#=====================================================================
...
###Updated: should be take into account the whole population
#=====================================================================
...
set_2013_F<-filter(dataset,birth_year==2013,sex=='F')
set_2013_M<-filter(dataset,birth_year==2013,sex=='M')
inner_2013<-merge(set_2013_F,set_2013_M, by='name') 

final_2013<- subset(inner_2013,select=c(name,occurrence.x,occurrence.y))
final_2013[,2]
inner_2013[,5]


final_2013$total_2013<-(final_2013$occurrence.x + final_2013$occurrence.y)
final_2013<- subset(final_2013,select=c(name,total_2013))
final_2013
ffff_2013<-aggregate(name~c(occurrence.x,occurrence.y))
...
data_all$num_1980<- (data_all$num_1980)*1.0/sum(data_all$num_1980)




data_all$change<- ((data_all$num_1980)/sum(data_all$num_1980)-(data_all$num_1981)/sum(data_all$num_1981)*100)
...
```{r}
#Something related to the baby's name that linked to movies or others.
